...
public class ConsolaOlimpicos
{
	...
	private void ejecutarPaisDelAtleta()
	{
		...
		Pais nombre_pais = calculadora.paisDelAtleta(nombre_atleta);
		String elPais = nombre_pais.darNombre();
		
		System.out.println("El atleta '" + nombre_atleta + "' representa a "  + elPais);
